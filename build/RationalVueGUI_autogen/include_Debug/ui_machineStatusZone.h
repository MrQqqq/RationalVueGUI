...
public:
    ...
    void setupUi(QWidget *CMachineStatusZone)
    {
        if (CMachineStatusZone->objectName().isEmpty())
            CMachineStatusZone->setObjectName(QStringLiteral("CMachineStatusZone"));
        CMachineStatusZone->setEnabled(true);
        CMachineStatusZone->resize(400, 210);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(CMachineStatusZone->sizePolicy().hasHeightForWidth());
        CMachineStatusZone->setSizePolicy(sizePolicy);
        CMachineStatusZone->setAutoFillBackground(true);
        verticalLayout = new QVBoxLayout(CMachineStatusZone);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(-1, 6, -1, -1);
        widget = new QWidget(CMachineStatusZone);
        ...
        widget_2 = new QWidget(CMachineStatusZone);
        ...
        widget_3 = new QWidget(CMachineStatusZone);
        ...
        widget_4 = new QWidget(CMachineStatusZone);
    ...
    void retranslateUi(QWidget *CMachineStatusZone)
    {
        CMachineStatusZone->setWindowTitle(QApplication::translate("CMachineStatusZone", "Form", Q_NULLPTR));
        toolButton_1->setText(QApplication::translate("CMachineStatusZone", "...", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("CMachineStatusZone", "MCS", Q_NULLPTR));
        toolButton_2->setText(QApplication::translate("CMachineStatusZone", "...", Q_NULLPTR));
        label_1->setText(QApplication::translate("CMachineStatusZone", "X", Q_NULLPTR));
        label_2->setText(QApplication::translate("CMachineStatusZone", "X", Q_NULLPTR));
        label_3->setText(QApplication::translate("CMachineStatusZone", "Y", Q_NULLPTR));
        label_4->setText(QApplication::translate("CMachineStatusZone", "Y", Q_NULLPTR));
        label_5->setText(QApplication::translate("CMachineStatusZone", "Z", Q_NULLPTR));
        label_6->setText(QApplication::translate("CMachineStatusZone", "Z", Q_NULLPTR));
    } // retranslateUi
