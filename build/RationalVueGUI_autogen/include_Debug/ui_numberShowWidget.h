/********************************************************************************
** Form generated from reading UI file 'numberShowWidget.ui'
**
...
#ifndef UI_NUMBERSHOWWIDGET_H
#define UI_NUMBERSHOWWIDGET_H
...
public:
    ...
    void setupUi(QWidget *CNumberShowWidget)
    {
        if (CNumberShowWidget->objectName().isEmpty())
            CNumberShowWidget->setObjectName(QStringLiteral("CNumberShowWidget"));
        CNumberShowWidget->setEnabled(true);
        CNumberShowWidget->resize(290, 210);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(CNumberShowWidget->sizePolicy().hasHeightForWidth());
        CNumberShowWidget->setSizePolicy(sizePolicy);
        CNumberShowWidget->setAutoFillBackground(true);
        verticalLayout = new QVBoxLayout(CNumberShowWidget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        widget = new QWidget(CNumberShowWidget);
        ...
        widget_2 = new QWidget(CNumberShowWidget);
        ...
        widget_3 = new QWidget(CNumberShowWidget);
        ...
        widget_4 = new QWidget(CNumberShowWidget);
        ...
        retranslateUi(CNumberShowWidget);

        QMetaObject::connectSlotsByName(CNumberShowWidget);
    } // setupUi

    void retranslateUi(QWidget *CNumberShowWidget)
    {
        CNumberShowWidget->setWindowTitle(QApplication::translate("CNumberShowWidget", "Form", Q_NULLPTR));
        toolButton_1->setText(QApplication::translate("CNumberShowWidget", "...", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("CNumberShowWidget", "MCS", Q_NULLPTR));
        toolButton_2->setText(QApplication::translate("CNumberShowWidget", "...", Q_NULLPTR));
        label_1->setText(QApplication::translate("CNumberShowWidget", "X", Q_NULLPTR));
        label_2->setText(QApplication::translate("CNumberShowWidget", "X", Q_NULLPTR));
        label_3->setText(QApplication::translate("CNumberShowWidget", "Y", Q_NULLPTR));
        label_4->setText(QApplication::translate("CNumberShowWidget", "Y", Q_NULLPTR));
        label_5->setText(QApplication::translate("CNumberShowWidget", "Z", Q_NULLPTR));
        label_6->setText(QApplication::translate("CNumberShowWidget", "Z", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CNumberShowWidget: public Ui_CNumberShowWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NUMBERSHOWWIDGET_H
